...
<nav class="navbar navbar-expand-lg border-bottom">
    <div class="container-fluid px-4">
        ...
        <div class="d-flex gap-3 align-items-center">
            ...
            <a class="nav-link" href="/pages/faq2.php">FAQ</a>
        </div>
...
<!-- Includes the  Logout modal so it can be used in this page-->
<?php require_once __DIR__ . '/logout_modal.php'; ?>
<!-- Bootstrap and java needed for modal function open and close animations from bootstrap offical docs-->
